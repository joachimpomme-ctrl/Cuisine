...
> **Gem Gemini (limite ~10 fichiers)** : ne pas charger les 20 fichiers ci-dessus ; utiliser à la place les 9 bundles consolidés de `../gem-gemini/` (même contenu, regroupé).
